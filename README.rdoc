...
This is a blogging application using Ruby on Rails.

This application addresses the following user stories:
...
View the site here: https://github.com/gracelauren/railsblog


Run the programming by cloning the repository, cd-ing into folder and then running:
<tt>bundle</tt>.
