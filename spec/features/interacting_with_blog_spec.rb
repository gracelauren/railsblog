...
describe "user interacts with blog" do
  it "adds a new post" do
    ...
    fill_in_forms('Test Post Title', 'Test Post Entry', '2015-03-20 21:53:00 UTC')
  ...
  it "edits a post" do
    ...
    click_link 'Edit'
    fill_in_forms('New Post Title', 'New Post Entry', '2015-03-20 21:53:00 UTC')
  ...
  it "adds a new comment" do
    ...
    fill_in_forms('Test Comment Title', 'Test Comment Entry', '2015-03-20 21:53:00 UTC')
  ...
  it "edits and destroys a new comment" do
    ...
    fill_in_forms('Test Comment Title', 'Test Comment Entry', '2015-03-20 21:53:00 UTC')
    click_link "Edit"
    fill_in_forms('New Comment Title', 'New Comment Entry', '2015-03-20 21:53:00 UTC')
